module github.com/axonfibre/fibre.go/sql

go 1.22.0

require (
	github.com/axonfibre/fibre.go/db v0.0.0-20240517131232-748f1ce3a2d2
...
require (
	...
	github.com/axonfibre/fibre.go/lo v0.0.0-20240517131232-748f1ce3a2d2 // indirect
